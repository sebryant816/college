...
<html lang="en">
  <head>
  <title>College Course page</title>  
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-left section-heading probootstrap-animate">
              <h1 style="font-size:76px;font-family: 'Domine', serif;"><strong> Our Courses:</strong></h1>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="probootstrap-section probootstrap-section-colored">
        <div class="row">
          ...
          <tr style="border-top:1px solid black; background-color:#ca99ff;"> 
            ...
            <td style="padding-left:20px"><?=$row['coursename']?></td>
           ...
           <tr>
           <td colspan="12" style="padding-top:20px;padding-bottom:10px;padding-left:20px;padding-right:20px;"><strong>Course Description: </strong><?=$row['coursedesc']?></td>
           </tr>
